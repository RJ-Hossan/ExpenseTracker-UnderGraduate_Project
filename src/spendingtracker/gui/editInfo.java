...
public class editInfo extends javax.swing.JFrame {
    ...
    public editInfo() throws SQLException {
            initComponents();
    ...
    private void kButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kButton3ActionPerformed
        ...
        try {
            if(verifyFields()){
                String query = "Update user set User_ID=?, Name=?, Contact_No=?, Email_ID=?, Date_of_Birth=?  where User_ID=?";
                String query1 = "Update login_info set User_Name=?, Password=?, User_ID=? where User_ID=?";
