...
public class spending extends javax.swing.JFrame{
    ...
    void showCategory(){
        try {
            pst = con.prepareStatement("SELECT Category_Name from category_info WHERE User_ID=?");
            pst.setInt(1, sp.id);
    ...
    void showMember(){
        try {
            pst = con.prepareStatement("SELECT Member_Name from member_info WHERE User_ID=?");
            pst.setInt(1, sp.id);
            
            ResultSet rs = pst.executeQuery();
            while(rs.next()){
                jComboBox2.addItem(rs.getString("Member_Name"));
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e);
        }
    ...
    void showData(){
        try {
            String query = "SELECT * FROM spending_info WHERE User_ID=?";
            String query1 = "SELECT Member_Name FROM spent_by WHERE User_ID=?";
            String query2 = "SELECT Category_Name FROM category_info WHERE Category_Name=?";
...
//                String cat = rs2.getString("Category_Name");
//                String payee = rs1.getString("Member_Name");
                String date = rs.getString("Spending_Date");
                String am = rs.getString("Amount");
                Object obj[] = {++c, date, am};
                tm.addRow(obj);
            }
        } 
        catch (Exception e) {
    ...
    private void initComponents() {
        ...
        jLabel5.setForeground(new java.awt.Color(0, 241, 235));
        ...
        jTabbedPane1.setFont(new java.awt.Font("Cambria", 1, 13)); // NOI18N
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "SL No", "Category Name", "Payee", "Date", "Amount"
            }
        ) {
        ...
        jLabel11.setText("Add Expense Info");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Add New Category" }));

        jLabel15.setBackground(new java.awt.Color(255, 255, 255));
        jLabel15.setFont(new java.awt.Font("Cambria", 1, 13)); // NOI18N
        jLabel15.setForeground(new java.awt.Color(80, 135, 185));
        jLabel15.setText("Payee");

        jComboBox2.setFont(new java.awt.Font("Cambria", 0, 13)); // NOI18N
        jComboBox2.setForeground(new java.awt.Color(80, 135, 185));
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Add New Member" }));

        jLabel16.setBackground(new java.awt.Color(255, 255, 255));
        jLabel16.setFont(new java.awt.Font("Cambria", 1, 13)); // NOI18N
        jLabel16.setForeground(new java.awt.Color(80, 135, 185));
        jLabel16.setText("Spending ID");

        kButton2.setText("Add Expense");
        ...
        jTabbedPane1.addTab("View Expense", jPanel6);
...
//        this.dispose();
    ...
    private void kButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kButton2ActionPerformed
        // TODO add your handling code here:
        try{
            String nt = jTextPane1.getText();
            String am = jTextField1.getText();
            String cat = jComboBox1.getSelectedItem().toString();
            String member = jComboBox2.getSelectedItem().toString();
            int c = 0;
            if(verifyFields()){
                int amount = Integer.parseInt(am);
                
                String query ="INSERT INTO spending_info(Spending_ID, Spending_Date, Amount, Note, User_ID) values(?, ?, ?, ?, ?)";
                pst = con.prepareStatement(query);
                ...
                pst1 = con.prepareStatement("INSERT INTO spent_by values(?,?,?)");
                pst1.setString(1, member);
                pst1.setInt(2, sp.id);
                pst1.setString(3, jTextField2.getText());
                
                
                pst2 = con.prepareStatement("INSERT INTO category_info(Category_ID, Category_Name, User_ID) values(?, ?, ?)");
                pst2.setString(1, cat + "-" + sp.id);
                pst2.setInt(2, sp.id);
                pst2.setString(3, cat);
    ...
    public boolean verifyFields(){
        ...
        String field2 = jTextPane1.getText();
        String cat = jComboBox1.getSelectedItem().toString();
        String member = jComboBox2.getSelectedItem().toString();
        String dob = ((JTextField)jDateChooser1.getDateEditor().getUiComponent()).getText();
        
        if(field1.trim().equals("") || field2.trim().equals("") || cat.trim().equals("") || member.trim().equals("") || dob.trim().equals("")){
